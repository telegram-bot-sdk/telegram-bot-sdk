 ...
 *
 * @property int $migrate_to_chat_id (Optional). The group has been migrated to a supergroup with the specified identifier.
 ...
 */
class ResponseParameters extends AbstractResponseObject
{
}
