 ...
 */
class ShippingQuery extends AbstractResponseObject
{
    /**
     * @return array{from: class-string<\Telegram\Bot\Objects\User>, shipping_address: class-string<\Telegram\Bot\Objects\Payments\ShippingAddress>}
     */
