 ...
 *
 *string  @link https://core.telegram.org/bots/api#inlinequeryresultcachedvoice
 *
 * @method $this id(string $string) Required. Unique identifier for this result, 1-64 bytes
 * @method $this voiceFileId(string $string) Required. A valid file identifier for the voice message
 * @method $this title(string $string) Required. Voice message title
