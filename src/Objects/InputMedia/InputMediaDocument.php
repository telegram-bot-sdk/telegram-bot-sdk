 ...
 * @method $this disableContentTypeDetection($bool)      (Optional). Disables automatic server-side content type detection for files uploaded using multipart/form-data. Always true, if the document is sent as part of an album.
 */
